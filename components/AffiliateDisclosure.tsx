type Props = {
  className?: string;
  /** Append the FTC-required Amazon Associates statement. */
  amazon?: boolean;
};
...
export const AMAZON_ASSOCIATES_TEXT =
  "As an Amazon Associate, we earn from qualifying purchases.";

export default function AffiliateDisclosure({ className = "", amazon = false }: Props) {
  return (
    <p
